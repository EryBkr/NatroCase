    ...
    where TRequest : IRequest<TResponse>, ICachableRequest
{
    ...
    /// <summary>
    /// The concept of Cache Group is actually a mechanism that stores cache keys in Redis and, in the event of manipulation of a dataset belonging to that group, uses all the keys in the group to clear the cache
    /// </summary>
